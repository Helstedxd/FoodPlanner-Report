...
Another alternative could be the website madplanuge.dk\cite{madSpild_madPlanUge}, where a foodplan can be planned one week ahead, but the users storage is taken into consideration.
