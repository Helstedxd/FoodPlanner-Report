...
How is it possible to create a software solution that caters to the needs of those who wants to save resources such as time and money when shopping. Meanwhile still maintain a low foodwaste level, and still want to be able to %fulfill their food lifestyle choices%. This can be summed up in the following list:
...
%maintain low foodwaste level
%uddyb spar tid og penge, bsøg antal butikker for den bedste pris.
%holde styr på inventory
