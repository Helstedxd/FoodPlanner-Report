...
\includegraphics[width=1.0\textwidth]{ApplicationDomain/spViewInventory.pdf} \label{Inventory_Figure}
...
\includegraphics[width=1.0\textwidth]{ApplicationDomain/spEditInventory.pdf} \label{spEditInventory}
