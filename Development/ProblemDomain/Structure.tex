\section{Event Patterns} \label{EventPatters}\fxnote{hele afsnittet er ændret}
...
\begin{figure}[tbhp]
	...
	\caption{Statemachine diagram for the food class} \label{FoodClass} \fxnote{figurens placering er måske for langt væk fra tekseten.}
\end{figure}
...
Some of the event patterns used to understand this class are:\fxnote{gentagelse}
\begin{itemize}
...
\subsection{User Settings Class}\fxnote{skal laves, hilsen Gideon<3}

\fxnote{Anders: Start and finish for the diagram is needed (der må være flee events)}
...
\end{figure}\fxnote{ret avaible til available og scheduele til scheduled}
