...
A Wi-fi connection is a wireless connection to the internet.This is a useful technology because all tablets and smartphones has Wi-fi technology\fxnote{en kilde?}. Wi-fi can be used to access data that are stored on other devices which are not used by a user such as a server. It can also be used between devices on the same network to synchronize changes in the program.    
